...
public abstract class Bag {
    ...
    public boolean addItem(String item){
        ...
        if (this.numberOfContents < this.capacity){
            ArrayList<String> lists = new ArrayList<String>(Arrays.asList(this.contents));
            lists.add(item);
            this.contents = lists.toArray(new String[0]);
    ...
    public String popItem(){
        if (this.numberOfContents == 0){
            ...
            ArrayList<String> lists = new ArrayList<String>(Arrays.asList(this.contents));
            String toReturn = lists.get(this.numberOfContents);
            lists.remove(this.numberOfContents);
            this.numberOfContents -= 1;
            this.contents = lists.toArray(new String[0]);
            return toReturn;
        }
